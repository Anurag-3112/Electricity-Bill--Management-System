...
public class calculate_bill extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        String meter_number = c1.getSelectedItem();
        String units_str = t1.getText();
        String month = c2.getSelectedItem();

        try {
            int units = Integer.parseInt(units_str);
            // Calculation logic
            int total_bill = units * 7 + 50 + 12 + 102 + 20 + 50; // Example calculation

            String q = "INSERT INTO bill (meter_number, month, units, total_bill, status) VALUES ('" +
                    meter_number + "','" + month + "','" + units + "','" + total_bill + "','Not Paid')";
